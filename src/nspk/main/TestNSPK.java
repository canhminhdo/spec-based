...
//		args = new String[] {"{nw: (m1(p,p,intrdr,c1(intrdr,n(p,intrdr,r1),p)) m1(intrdr,p,q,c1(q,n(p,intrdr,r1),p)) m2(q,q,p,c2(p,n(p,intrdr,r1),n(q,p,r2),q)) m1(intrdr,intrdr,q,c1(intrdr,n(p,intrdr,r1),p)) m2(intrdr,intrdr,p,c2(p,n(p,intrdr,r1),n(q,p,r2),q)) m3(p,p,intrdr,c3(intrdr,n(q,p,r2))) m1(intrdr,p,q,c1(intrdr,n(p,intrdr,r1),p)) m2(intrdr,q,p,c2(p,n(p,intrdr,r1),n(q,p,r2),q)) m3(intrdr,p,q,c3(q,n(q,p,r2)))) rand: emp prins: (p q intrdr) nonces: (n(p,intrdr,r1) n(q,p,r2)) rw_p: (Confirmation) rw_q: emp rw_intrdr: (Fake)}"};
		if (args.length > 0) {
			// Read arguments
