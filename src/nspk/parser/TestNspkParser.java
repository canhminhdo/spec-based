...
public class TestNspkParser {

	public static void main(String[] args) {
		String str = "{nw: (m1(p, p, intrdr, c1(intrdr, n(p, intrdr, r1), p)) m1(intrdr, p, q, c1(q, n(p, intrdr, r1), p)) m2(q, q, p, c2(p, n(p, intrdr, r1), n(q, p, r2))) m2(intrdr, intrdr, p, c2(p, n(p, intrdr, r1), n(q, p, r2))) m3(p, p, intrdr, c3(intrdr, n(q, p, r2)))) rand: r1 r2 nonces: (n(p, intrdr, r1) n(q, p, r2)) prins: (p q intrdr) rw_p: (Challenge Confirmation) rw_q: (Confirmation) rw_intrdr: emp}";
